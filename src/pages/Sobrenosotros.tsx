...
export default function SobreNosotros() {
  const stats = [
    { number: "2+", label: "Clientes Satisfechos" },
    { number: "1+", label: "Productos Vendidos" },
  ...
  const team = [
    {
      ...
      description: "Visionario con más de 1 año de experiencia en desarrollo de software",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              de calidad y un servicio excepcional desde 2025.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Sanda nació en 2025 con una visión simple pero poderosa: hacer que las compras online sean más
